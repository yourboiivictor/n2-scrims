  ...
  return (
    <main className="pointer-events-none min-h-screen bg-transparent text-white antialiased">
      ...
      <div className="flex min-h-screen items-center justify-end px-6 py-4">
        <aside className="overlay-enter flex h-[94vh] w-[min(32vw,520px)] min-w-[440px] flex-col overflow-hidden border border-white/20 bg-black/30 backdrop-blur-[1px]">
          ...
          <section className="min-h-0 flex-1 overflow-hidden bg-black/20 px-4 py-4">
            ...
            <div className="mt-3 space-y-2">
              {visibleStandings.length === 0 ? (
                <div className="border border-white/20 bg-black/25 p-8 text-center text-sm font-bold text-neutral-300">
...
function InfoBox({
  ...
  return (
    <div className="border border-white/20 bg-black/20 px-3 py-3">
...
function StandingRow({
  ...
  return (
    <div
      className="grid grid-cols-[42px_46px_minmax(0,1fr)_54px_60px] items-center gap-2 border border-white/15 bg-black/25 px-3 py-3"
    >
      <div
