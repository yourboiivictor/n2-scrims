...
export default function StreamStandingsOverlay() {
  ...
  return (
    <main className="min-h-screen bg-transparent p-3 text-white">
      <section className="w-[460px] overflow-hidden rounded-2xl border border-white/20 bg-transparent shadow-2xl">
        <header className="flex items-center justify-between border-b border-white/20 bg-black px-4 py-3">
          <div>
          ...
          <span className="rounded-full bg-white text-black px-3 py-1 text-xs font-black">
            LIVE
          </span>
        </header>
        ...
        <div>
          {rankedStandings.length === 0 ? (
            <div className="bg-transparent p-5 text-center text-sm text-neutral-400">
            ...
            rankedStandings.map((standing, index) => (
              <div
                key={standing.id}
                className={`grid grid-cols-[38px_38px_48px_1fr_68px] items-center gap-2 border-b border-white/20 bg-transparent px-3 py-2 last:border-b-0 ${
              ...
              >
                ...
                <div className="text-center text-xs font-black text-neutral-400">
                  #{standing.slot || "-"}
                </div>

                <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-lg border border-white bg-white">
                  {standing.logoUrl ? (
