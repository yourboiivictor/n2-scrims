      ...
      <div className="mx-auto max-w-[1500px]">
        <header className="rounded-2xl border border-white/10 bg-slate-900/90 p-5 shadow-2xl">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div><p className="text-xs font-black uppercase tracking-[0.22em] text-violet-400">N² Scrims Admin</p><h1 className="mt-1 text-3xl font-black">{settings.name}</h1><p className="mt-1 text-sm text-slate-400">{settings.season ? `Season ${settings.season} · ` : ""}{live ? "Live standings" : "Tournament standings"}</p></div>
            <div className="flex flex-wrap gap-2"><Link href="/admin/matches" className="rounded-lg bg-violet-600 px-4 py-2.5 text-sm font-black">Live Dashboard</Link><Link href="/admin/settings" className="rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-black">Settings</Link><Link href="/admin/graphics" className="rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-black">Graphics</Link><Link href="/tournament" className="rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-black">Public Page</Link></div>
          </div>
